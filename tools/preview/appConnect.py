...
# (c) 2014-2019
#
# App-specific functions for Preview.
...
class AppConnect(object):
	""" Connects Preview to the relevant application and passes args to its
		internal preview API.
	"""
	#def __init__(self, **kwargs):
	def __init__(self, fileInput, format, activeView, camera, res, frRange, 
		         offscreen, noSelect, guides, burnin, interruptible):
