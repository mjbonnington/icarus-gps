...
inline int wrap(int in, int min, int max);

inline int step(int in, int value);

inline int pulse(int in, int min, int max);
...
_DJV_BASE List<Range<int> > range(const List<int> &);
