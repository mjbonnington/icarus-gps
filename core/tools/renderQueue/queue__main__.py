...
import datetime, os, socket, sys, threading, time
...
class gpsRenderQueueApp(QtGui.QMainWindow):
	...
	def updateRenderQueueView(self):
		...
		"""
	#	threading.Timer(1.0, self.updateRenderQueueView).start()
	...
	def startRender(self, cmdStr):
		...
		if os.environ['ICARUS_RUNNING_OS'] == 'Windows':
			...
			self.renderProcess = subprocess.Popen(cmdStr, stdout=subprocess.PIPE)
			#print self.renderProcess
