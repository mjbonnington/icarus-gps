...
class gpsRenderSubmitApp(QtGui.QDialog):
	...
	def sceneBrowse(self):
		...
		if filePath[0]:
			...
			if newEntry:
				...
				verbose.print_("Warning: Only scenes belonging to the current shot can be submitted.", 2)
	...
	def submit(self):
		...
		try:
			...
			verbose.print_("ERROR: Path to Maya Render command executable not found. This can be set with the environment variable 'MAYARENDERVERSION'.", 2)
