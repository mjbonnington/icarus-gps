...
#
# Created: Tue May 19 18:09:28 2015
...
class Ui_settings_frame(object):
    def setupUi(self, settings_frame):
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.LabelRole, self.full_label)
        ...
        self.formLayout.setLayout(1, QtGui.QFormLayout.FieldRole, self.full_horizontalLayout)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.LabelRole, self.proxy_label)
        ...
        self.formLayout.setLayout(4, QtGui.QFormLayout.FieldRole, self.proxy_horizontalLayout)
        ...
        settings_frame.setTabOrder(self.resPreset_comboBox, self.fullWidth_spinBox)
        ...
        settings_frame.setTabOrder(self.proxyHeight_spinBox, self.preserveAR_checkBox)
