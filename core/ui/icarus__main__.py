...
if os.environ['IC_ENV'] == "STANDALONE":
	...
	parser.add_argument("-b", "--bytecode", help="write bytecode", type=str2bool)
	args = parser.parse_args()
	if args.user:
		os.environ['IC_USERNAME'] = args.user.lower()
	if args.bytecode is not None:
		os.environ['IC_WRITEBYTECODE'] = str(args.bytecode)

# Don't write .pyc (or __pycache__) if the -b argument is set to false:
try:
	sys.dont_write_bytecode = not str2bool(os.environ['IC_WRITEBYTECODE'])
except KeyError:
	pass
# print("Don't write bytecode: %s" %sys.dont_write_bytecode)
...
""" %(os.environ['IC_VERSION'], python_ver_str, pyside_ver_str, qt_ver_str, os.environ['IC_RUNNING_OS'], os.environ['IC_ENV'])
		...
		import about
		# reload(about)  # Python 3 doesn't like this
