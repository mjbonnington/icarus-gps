...
def run_maya():
	""" Run in Maya.
	"""
	# dcc_app_integration.maya_delete_ui(WINDOW_TITLE, WINDOW_OBJECT)  # Delete any already existing UI
	# icApp = IcarusApp(parent=dcc_app_integration.maya_main_window())
...
def run_nuke():
	...
	"""
	# dcc_app_integration.nuke_delete_ui(WINDOW_TITLE, WINDOW_OBJECT)  # Delete any already existing UI
